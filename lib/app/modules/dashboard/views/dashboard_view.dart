...
class DashboardView extends GetView<ProductsController> {
  ...
  Widget build(BuildContext context) {
    return Obx(() => Scaffold(
          backgroundColor:
              settingsController.selectedPersona.value?.backgroundColor ??
                ...
                Padding(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Card(
                        color: settingsController
                                .selectedPersona.value?.secondaryColor ??
                            Color.fromARGB(255, 232, 252, 243),
                        elevation: 4,
          ...
          floatingActionButton: FloatingActionButton(
            ...
            backgroundColor:
                settingsController.selectedPersona.value?.primaryColor ??
                    Color.fromARGB(255, 20, 121, 91),
          ),
        ));
  }
